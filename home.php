...
<body>
   ...
   <header class="header fixed-top">
      ...
      <div class="container">
         ...
         <div class="row align-items-center justify-content-between">
            ...
            <a href="#home" class="logo">Atlas<span>Care.</span></a>
   ...
   <section class="contact" id="contact">
      ...
      <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
         ...
         ?>
         <span>your id :</span>
         <input type="text" name="id" placeholder="enter your id number" class="box" required>
         <span>your name :</span>
   ...
   <section class="footer">
      ...
      <div class="box-container container">
         ...
         <div class="box">
            ...
            <h3>email address</h3>
            <p>dnyasio2014@gmail.com</p>
         </div>

      </div>

      <div class="credit"> &copy; copyright @ <?php echo date('Y'); ?> by <span>Derrick Nyasio</span> </div>
